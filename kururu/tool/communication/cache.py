...
class Cache(Container1):
    ...
    REMINDER: ele processaria em cada worker e depois o step interno tentaria processar de novo, i.e.
     o cache criaria um stream pra competir com o oficial"""
    ...
    def _process_(self, data: AbsData):
        if data.stream:
            print("Cache cannot handle stream.\nHINT: use Map(Cache(...)) or cache enclosing the expander (e.g. Partition) and Reduce.")
